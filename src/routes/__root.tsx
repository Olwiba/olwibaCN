...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: 'olwibaCN - Component Registry' },
      { name: 'description', content: 'A beautifully crafted component registry. Copy and paste components into your apps.' },
      { property: 'og:title', content: 'olwibaCN - Component Registry' },
      { property: 'og:description', content: 'A beautifully crafted component registry. Copy and paste components into your apps.' },
