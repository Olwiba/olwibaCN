...
// Re-exported so the many demos importing these from here keep working. The
// definitions live in ./demo-controls, which is what published demos import.
export { DemoControls, LiveUsageCode, useUsageCode } from './demo-controls';
  ...
  return (
    <ControlsPortalContext.Provider value={portalTarget}>
      ...
      <div className="border border-dashed border-fd-border rounded-lg overflow-visible not-prose my-6">
        ...
        <div data-slot="component-preview-canvas" className="p-8 bg-fd-background flex items-center justify-center min-h-[200px]">
          {Demo ? (
