...
const ContextMenuSubContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.SubContent> & { mode?: ContextMenuMode }
...
const ContextMenuContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Content> & { mode?: ContextMenuMode }
>(({ className, mode: modeProp, children, ...props }, ref) => {
  const inheritedMode = useUIVariant()
  const mode = modeProp ?? inheritedMode
